...
class StarterkitInstalationCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->call('migrate',[
            '--path' => [
                str_replace($rootProject,'',__DIR__.'/../database/migrations/2022_06_09_141918_create_cms_privileges_table.php'),
                str_replace($rootProject,'',__DIR__.'/../database/migrations/2022_06_09_142604_create_cms_moduls_table.php'),
                str_replace($rootProject,'',__DIR__.'/../database/migrations/2022_06_09_142732_create_cms_users_table.php'),
                str_replace($rootProject,'',__DIR__.'/../database/migrations/2022_06_09_142946_create_cms_privileges_roles_table.php'),
                str_replace($rootProject,'',__DIR__.'/../database/migrations/2022_06_15_121257_create_cms_notification_table.php'),
            ]
        ]);
